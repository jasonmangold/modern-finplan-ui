          ...
          <div key={category.name} className="border rounded-lg">
            ...
            {expandedCategories.includes(category.name) && (
              <div className="border-t">
                ...
                {category.name === "Retirement" && (
                  <>
                    <div className="px-4 py-2 bg-gray-50 border-b">
                      <Checkbox id="retirement-basics" className="mr-2" />
                      <label htmlFor="retirement-basics" className="text-sm font-medium">Retirement Planning Basics</label>
                    </div>
                    <div className="px-8 py-2 space-y-2">
                      {["401(k) vs IRA: Understanding Your Options", "Required Minimum Distributions (RMDs)", "Tax-Deferred vs Tax-Free Retirement Accounts"].map(report => (
                        <div key={report} className="flex items-center justify-between p-2 hover:bg-gray-50 rounded">
                          <div className="flex items-center gap-3">
                            <Checkbox 
                    ...
                    <div className="px-4 py-2 bg-gray-50 border-b border-t">
                      <Checkbox id="advanced-retirement" className="mr-2" />
                      <label htmlFor="advanced-retirement" className="text-sm font-medium">Advanced Retirement Strategies</label>
                    </div>
                    <div className="px-8 py-2 space-y-2">
                ...
                {/* For other categories, show simple report list */}
                {category.name !== "Retirement" && (
