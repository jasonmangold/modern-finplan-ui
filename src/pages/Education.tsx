...
const educationReports = ["The Need for Financial Planning", "The Need for Retirement Planning (2)", "The Need for Retirement Planning (3)", "The Need for Retirement Planning 4", "Up to Your Neck in Debt?", "Budgeting Basics", "Income Tax Fundamentals", "Advanced Tax Strategies", "Tax Planning Guide", "Investment Planning 101", "Understanding Mutual Funds", "Stocks and Bonds Basics", "Alternative Investments", "The Road to Retirement Planning"];
